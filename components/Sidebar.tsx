        ...
        <div className="flex flex-col h-full p-6">
          ...
          <div className="space-y-1 mb-10">
            ...
            <button 
              ...
              className={`flex items-center gap-3 w-full p-3 rounded-xl transition-all ${currentView === 'faq' ? 'bg-gray-50 text-black font-medium' : 'text-gray-500 hover:bg-gray-50 hover:text-black'}`}
            >
